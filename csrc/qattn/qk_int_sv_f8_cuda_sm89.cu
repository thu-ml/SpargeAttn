      ...
      DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
        DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
          DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
            ...
            SpargeAttentionSM89Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, float, true, false, 0, DTypeOut, IS_CAUSAL, true, false, RETURN_LSE>(
        ...
        DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
              ...
              SpargeAttentionSM89Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, float, true, false, 1, DTypeOut, IS_CAUSAL, true, RETURN_PV_COUNT, RETURN_LSE>(
                reinterpret_cast<int8_t*>(query.data_ptr()),
                reinterpret_cast<int8_t*>(key.data_ptr()),
                reinterpret_cast<__nv_fp8_e4m3*>(value.data_ptr()),
                reinterpret_cast<DTypeOut*>(output.data_ptr()),
        ...
        DISPATCH_QK_QUANT_GRAN(qk_quant_gran, QK_QUANT_GRAN, {
          DISPATCH_PYTORCH_DTYPE_TO_CTYPE_FP16(output_dtype, DTypeOut, {
            DISPATCH_RETURN_LSE(return_lse, RETURN_LSE, {
              ...
              SpargeAttentionSM89Dispatched<CTA_Q, CTA_K, WARP_Q, WARP_K, HEAD_DIM, QK_QUANT_GRAN, float, true, true, 1, DTypeOut, IS_CAUSAL, true, RETURN_PV_COUNT, RETURN_LSE>(
                reinterpret_cast<int8_t*>(query.data_ptr()),
                reinterpret_cast<int8_t*>(key.data_ptr()),
                reinterpret_cast<__nv_fp8_e4m3*>(value.data_ptr()),
                reinterpret_cast<DTypeOut*>(output.data_ptr()),
